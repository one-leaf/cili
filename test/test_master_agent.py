"""Tests for core/agent.py — pure logic methods (master).
...
class TestIterContentBlocks:
    ...
    def test_string_content(self):
        ...
        blocks = list(Agent.iter_content_blocks(messages))
    ...
    def test_empty_messages(self):
        assert list(Agent.iter_content_blocks([])) == []
...
class TestCountTokens:
    ...
    def test_consistency_with_compression(self, agent):
        """agent._count_messages_tokens 和 compression.count_messages_tokens 一致。"""
        from core.compression import count_messages_tokens
