...
@app.get("/api/workspaces/{workspace_uuid}/memory")
...
@app.get("/api/workspaces/{workspace_uuid}/memory/entries/{name}")
...
@app.put("/api/workspaces/{workspace_uuid}/memory/entries/{name}")
...
@app.post("/api/workspaces/{workspace_uuid}/memory/entries/{name}/archive")
...
@app.post("/api/workspaces/{workspace_uuid}/memory/entries/{name}/restore")
...
@app.post("/api/workspaces/{workspace_uuid}/memory/entries/{name}/delete")
...
@app.post("/api/workspaces/{workspace_uuid}/memory/consolidate")
...
@app.put("/api/workspaces/{workspace_uuid}/memory/settings")
