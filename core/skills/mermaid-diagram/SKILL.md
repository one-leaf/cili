---
name: Mermaid 图表生成
description: 生成 Mermaid 图表：流程图、架构图、时序图、脑图、状态图、ER图、时间线、用户旅程。Use when user mentions 画图、流程图、架构图、时序图、脑图、状态图、ER图、mermaid、序列图、系统图、结构图、路线图、用户旅程。
roles: [master, worker, lite]
---

# Mermaid Diagram Generator

Generate valid Mermaid diagram code from text descriptions. Output is wrapped in ` ```mermaid ` code blocks and rendered as SVG by the frontend.
...
Common diagram patterns with complete example code.
