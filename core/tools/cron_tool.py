...
class CronTool(Tool):
    ...
    description = (
        ...
        "The master agent decides whether to handle the task directly or delegate to a Worker/Lite sub-agent.\n"
        ...
        "- Tasks run through the master agent in a 'Cron Tasks' session\n"
